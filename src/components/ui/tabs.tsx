...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // Rolagem horizontal apenas na barra de abas (evita scroll da página no mobile).
      "flex h-10 max-w-full items-center justify-start overflow-x-auto rounded-md bg-muted p-1 text-muted-foreground [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:inline-flex sm:justify-center",
      className,
    )}
    {...props}
  />
