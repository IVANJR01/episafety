...
interface ContratoStockSummary {
  ...
  movimentos: { data: string; tipo: string; epi_nome: string; ca: string | null; tamanho: string | null; destino: string; quantidade: number }[];
                                            ...
                                            <div className="sm:hidden space-y-2 max-h-[300px] overflow-auto">
                                              {filteredMovs.length === 0 ? (
                                                ...
                                                <div key={idx} className="rounded-lg border border-border/60 p-3 space-y-1">
                                                  ...
                                                  <p className="text-xs font-semibold">{mov.epi_nome} {mov.ca ? <span className="text-[10px] text-muted-foreground font-normal">CA: {mov.ca}</span> : null} {mov.tamanho ? <span className="text-[10px] text-muted-foreground font-normal">({mov.tamanho})</span> : null}</p>
                                                ...
                                                <TableBody>
                                                  {filteredMovs.length === 0 ? (
                                                    ...
                                                    <TableRow key={idx} className="text-xs">
                                                      ...
                                                      <TableCell className="px-2 py-1.5 font-mono text-[10px] text-muted-foreground">{mov.ca || "—"}</TableCell>
